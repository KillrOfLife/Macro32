...
This is my own common library consisting of that of Scottokeebs kbd, and some custom made.


# Installation

1. Add a `COMMON` path to match where the `Common` folder is located.

   !todo replace SCOTTOKEEBS_KICAD with COMMON
